...
# For this project it is: /Users/paulcurtis/Development/cartridge_collection/cartridge_collection
...
SECRET_KEY = 'django-insecure-$!m(uuwo%wh)!0z=a+9x*k=o6@y#%ku=uk6!d4_(aad8mzwl4@'
...
if env.bool('USE_POSTGRES', False):
    DATABASES = {
        'default': {
            ...
            'NAME': os.environ.get('DB_NAME', 'cartridge_collection'),
